...
#define PortConfigSet_PortContainer_LED_PortPin_LED_GREEN  0
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_LED_PortPin_LED_BLUE  1
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_LED_PortPin_LED_RED  2
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_JTAG_PortPin_JTAG_TMS  3
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_JTAG_PortPin_JTAG_TDO  4
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_JTAG_PortPin_JTAG_TCLK  5
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_JTAG_PortPin_JTAG_TDI  6
